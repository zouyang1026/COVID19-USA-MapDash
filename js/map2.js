mapboxgl.accessToken =
        ...
        map.on('load', () => { //simplifying the function statement: arrow with brackets to define a function
            ...
            map.addSource('covid-counts', {
                type: 'geojson',
                data: 'https://raw.githubusercontent.com/zouyang1026/COVID19-USA-MapDash/main/assets/us-covid-2020-counts.json'
            });
            map.addLayer({
        ...
        function updateChartOnZoom() {
            ...
            var visibleFeatures = map.queryRenderedFeatures({layers: ['covid-counts-point']})
                .filter(function(feature) {
                    var coord = feature.geometry.coordinates;
                    return coord[0] >= SW.lng && coord[0] <= NE.lng && coord[1] >= SW.lat && coord[1] <= NE.lat;
                });
            ...
            c3.generate({
                ...
                axis: {
                    x: {
                        type: 'category',
                        categories: ['Current View']
                    }
                }
            });
        }

        map.on('zoomend', updateChartOnZoom);
